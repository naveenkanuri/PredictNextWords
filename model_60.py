...
def useModel():
    ...
    filename = "model_weights_saved_60.hdf5"
...
def makePrediction(inputSequence, model, numWords):
    ...
    if len(inputSequence)>60:
        inputSequence = inputSequence[-59:]

    while len(inputSequence) <60:
...
def train(): 
    ...
    filepath = "model_weights_saved_60.hdf5"
